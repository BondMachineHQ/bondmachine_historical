...
func (op R2o) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := ""
...
func (Op R2o) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
