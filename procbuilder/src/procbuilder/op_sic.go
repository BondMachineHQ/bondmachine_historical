...
func (op Sic) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := "\n"
...
func (Op Sic) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
