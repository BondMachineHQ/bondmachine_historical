...
func (op I2rw) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := ""
...
func (Op I2rw) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
