...
func (op Lfsr82r) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	// TODO
	return ""
}
...
func (Op Lfsr82r) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
