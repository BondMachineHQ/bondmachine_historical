...
func (op Inc) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	return ""
}
...
func (Op Inc) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
