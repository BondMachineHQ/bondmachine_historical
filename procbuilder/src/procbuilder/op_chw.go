...
func (op Chw) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := ""
...
func (Op Chw) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
