...
func (op R2s) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := ""
...
func (Op R2s) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
