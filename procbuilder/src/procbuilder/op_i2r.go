...
func (op I2r) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := ""
...
func (Op I2r) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
