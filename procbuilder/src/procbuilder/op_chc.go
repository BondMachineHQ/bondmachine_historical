...
func (op Chc) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := ""
...
func (Op Chc) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
