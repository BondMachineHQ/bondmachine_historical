...
func (op Add) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	// TODO
	return ""
}
...
func (Op Add) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
