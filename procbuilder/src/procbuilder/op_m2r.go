...
func (op M2r) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	result := ""
...
func (Op M2r) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
	// TODO Partial
