...
func (op R2owaa) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
...
func (Op R2owaa) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
