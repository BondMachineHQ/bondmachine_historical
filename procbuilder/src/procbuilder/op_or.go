...
func (op Or) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
	// TODO
	return ""
}
...
func (Op Or) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
