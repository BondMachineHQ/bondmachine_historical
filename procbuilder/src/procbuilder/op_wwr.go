...
func (op Wwr) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
...
func (Op Wwr) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
