...
func (op R2owa) Op_instruction_verilog_header(conf *Config, arch *Arch, flavor string) string {
...
func (Op R2owa) Abstract_Assembler(arch *Arch, words []string) ([]UsageNotify, error) {
